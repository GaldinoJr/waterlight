 ...
 */
public abstract class AbstractServerDAO implements IDAO{
    ...
    public AbstractServerDAO(String conexao, String table, String idTable, String dif){
        this.table = table;
        this.idTable = idTable;
        this.conexao = conexao;
    }

    protected AbstractServerDAO(String table, String idTable, String arqPHP){
        this.table = table;
        this.idTable = idTable;
        this.arqPHP = arqPHP;
    }
